...
// creating html elements using template literal
document.body.innerHTML = `
<div id="head" class="container-fluid bg-light my-4 pt-3 pb-2 ">
        <h1 id="title" class="text-center">Task Pagination</h1>
        <p id="description" class="text-center">Creating Pagination to set of data in each page</p>
    </div>

    <div class="container table-responsive bg-light p-3 pb-1">
        <table id="table" class="table table-striped table-bordered table-hover text-center">
            <thead class="bg-dark text-light h5">
                <tr>
                    <th>ID</th>
                    <th>Name</th>
                    <th>E-mail</th>
    ...
    <div id="buttons" class="d-flex justify-content-center my-4">
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li><a onclick="display(n-10,m-10)" id="previous" class="page-link text-black">&laquo;</a></li>
                <li><a onclick="display(0,10)" class="page-link text-black">1</a></li>
                <li><a onclick="display(10,20)" class="page-link text-black">2</a></li>
                <li><a onclick="display(20,30)" class="page-link text-black">3</a></li>
                <li><a onclick="display(30,40)" class="page-link text-black">4</a></li>
                <li><a onclick="display(40,50)" class="page-link text-black">5</a></li>
                <li><a onclick="display(50,60)" class="page-link text-black">6</a></li>
                <li><a onclick="display(60,70)" class="page-link text-black">7</a></li>
                <li><a onclick="display(70,80)" class="page-link text-black">8</a></li>
                <li><a onclick="display(80,90)" class="page-link text-black">9</a></li>
                <li><a onclick="display(90,100)" class="page-link text-black">10</a></li>
                <li><a onclick="display(n+10,m+10)" id="next" class="page-link text-black">&raquo;</a></li>
            </ul>
        </nav>
    </div>
...
// string the value from function
var n;
var m;
...
function display(a, b) {
    ...
    for (let i = a; i < b; i++) {
        ...
        cell1.innerText = `${details[i].id}`;
        var cell2 = newRow.insertCell(1);
        cell2.innerText = `${details[i].name}`;
        var cell3 = newRow.insertCell(2);
        cell3.innerText = `${details[i].email}`;
    }

    // using if conditions to restrict previous and next button
    if (m == 10) {
        previous.className = "page-link text-black disabled";
    }
    if (m > 10) {
        previous.className = "page-link text-black";
    }
    if (m == 100) {
        next.className = "page-link text-black disabled";
    }
    if (m < 100) {
        next.className = "page-link text-black";
    }
}